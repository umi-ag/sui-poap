...
export function isBCS(type: Type): boolean { return type === "0x2::bcs::BCS"; }

export interface BCSFields { bytes: Array<number> }
...
export class BCS { static readonly $typeName = "0x2::bcs::BCS"; static readonly $numTypeParams = 0;
 ...
 static fromFields( fields: Record<string, any> ): BCS { return new BCS( fields.bytes.map((item: any) => item) ) }
 ...
 static fromBcs( data: Uint8Array | string, encoding?: Encoding ): BCS { return BCS.fromFields( bcs.de([BCS.$typeName, ], data, encoding) ) }
