...
const Button = ({ children, onClick, disabled }: { children: ReactNode, onClick: MouseEventHandler, disabled?: boolean }) => (
  <button
...
const Home = () => {
  ...
  return (
    <div id="page" className="min-h-screen bg-gray-100 p-8">
      ...
      <p className='mb-4'>Current Status: <b>{status()}</b></p>
      ...
      <div>
        ...
        <p className='mt-2'>
          <a className='text-blue-400 underline' href={`https://suiscan.xyz/mainnet/tx/${digest}`}>
            {digest}
          </a>
        </p>
      </div>
