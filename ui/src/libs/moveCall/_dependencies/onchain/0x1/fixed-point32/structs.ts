...
export function isFixedPoint32(type: Type): boolean { return type === "0x1::fixed_point32::FixedPoint32"; }

export interface FixedPoint32Fields { value: bigint }
...
export class FixedPoint32 { static readonly $typeName = "0x1::fixed_point32::FixedPoint32"; static readonly $numTypeParams = 0;
 ...
 static fromFields( fields: Record<string, any> ): FixedPoint32 { return new FixedPoint32( BigInt(fields.value) ) }
 ...
 static fromBcs( data: Uint8Array | string, encoding?: Encoding ): FixedPoint32 { return FixedPoint32.fromFields( bcs.de([FixedPoint32.$typeName, ], data, encoding) ) }
