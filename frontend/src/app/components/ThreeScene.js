...
const ThreeScene = ({ props }) => {
    useEffect(() => {
        ...
        const basematerial = new THREE.MeshStandardMaterial({ map: basetexture, transparent: true, alphaTest: 0.5 });
        const basemesh = new THREE.Mesh(basegeometry, basematerial);

        const colorsGroup = new THREE.Group();

        const color1geometry = new THREE.PlaneGeometry(.45 / 6, .25);
        ...
        const color2geometry = new THREE.PlaneGeometry(.45 / 6, .25);
        ...
        const color3geometry = new THREE.PlaneGeometry(.45 / 6, .25);
        ...
        const color4geometry = new THREE.PlaneGeometry(.45 / 6, .56);
        ...
        const color5geometry = new THREE.PlaneGeometry(.45 / 6, .48);
        ...
        const color6geometry = new THREE.PlaneGeometry(.45 / 6, .35);
        ...
        const frontmaterial = new THREE.MeshStandardMaterial({ map: fronttexture, transparent: true, alphaTest: 0.5 });
        ...
        const designmaterial = new THREE.MeshStandardMaterial({ map: designtexture, transparent: true, alphaTest: 0.5 });
        ...
        const backmaterial = new THREE.MeshStandardMaterial({ map: backtexture, transparent: true, alphaTest: 0.5 });
        ...
        dateLoader.load(fontjson, function (font) {
            ...
            dateMesh.position.set(.3, .04, -0.012);
        ...
        numLoader.load(fontjson, function (font) {
            ...
            numMesh.position.set(.1, -.06, -0.012);
